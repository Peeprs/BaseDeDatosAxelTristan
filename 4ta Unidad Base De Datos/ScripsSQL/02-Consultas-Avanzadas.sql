...
ORDER BY r.Ventas DESC;
  ...
  FROM Products;
   ...
   SELECT ProductID AS [N�mero producto],
  ...
  *FROM Products AS [Pr]
  ...
  SELECT pr.ProductID AS [N�mero producto],
...
--listar los pedidos superirores a 25000, mostrando el numero de pedido, el noombre del cliemte que lo encarg� y 
...
--�Cu�l es el rendimiento medio de la cuota de los representantes?
...
SELECT MIN (Fecha_Pedido) AS [Pedido m�s antiguo]
FROM Pedidos;
...
/*
   3) Seleccionar empleadps con mas pedidos realizados por año, ordenados por año y por numero de pedidos
*/
